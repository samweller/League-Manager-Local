  ...
  !isset($_POST['doaction3']) )
{
  ...
  elseif ( 'team' == $_POST['updateLeague'] )
  {
    ...
    $roster = ( isset($_POST['roster_group']) && !empty($_POST['roster_group']) ) ?
      array('id' => $_POST['roster'], 'cat_id' => $_POST['roster_group']) :
      array( 'id' => $_POST['roster'], 'cat_id' => false );
    $group = isset($_POST['group']) ? $_POST['group'] : '';

    if ( '' == $_POST['team_id'] )
    {
      $this->addTeam( $_POST['league_id'], $_POST['season'], $_POST['team'], $_POST['website'],
      $_POST['coach'], $_POST['stadium'], $home, $group, $roster, $custom, $_POST['logo_db'] );
    }
    else
    {
      $del_logo = isset( $_POST['del_logo'] ) ? true : false;
      $overwrite_image = isset( $_POST['overwrite_image'] ) ? true: false;
      $this->editTeam( $_POST['team_id'], $_POST['team'], $_POST['website'], $_POST['coach'],
      $_POST['stadium'], $home, $group, $roster, $custom, $_POST['logo_db'], $del_logo, $overwrite_image );
    }
  }
  // MATCH
...
// Search param for function -  $ location _ search
...
<div class="wrap">
  ...
  ?>
    ...
    <h3><?php _e( 'League Standings', 'leaguemanager' ) ?></h3>
    <?php
